// Navigation Bar Component - modern top navigation with user profile and notifications
        ...
        <div className="flex items-center space-x-4">
          <div className="flex items-center space-x-3">
            ...
            <div>
              ...
              <p className="text-sm text-gray-500 hidden sm:block">Manage your workforce</p>
            </div>
          </div>
        </div>
              ...
              <div className="absolute right-0 mt-2 w-80 bg-white rounded-lg shadow-lg border border-gray-200 z-50">
                ...
                <div className="max-h-64 overflow-y-auto">
                  ...
                  <div className="p-3 hover:bg-gray-50 border-b border-gray-100">
                    ...
                    <p className="text-xs text-gray-500">Sarah Johnson joined the Product team</p>
                    <p className="text-xs text-gray-400 mt-1">2 minutes ago</p>
                  </div>
                  <div className="p-3 hover:bg-gray-50 border-b border-gray-100">
                    <p className="text-sm font-medium text-gray-900">Salary review due</p>
                    <p className="text-xs text-gray-500">5 employees need salary reviews</p>
                    <p className="text-xs text-gray-400 mt-1">1 hour ago</p>
                  </div>
                  <div className="p-3 hover:bg-gray-50">
                    <p className="text-sm font-medium text-gray-900">System maintenance</p>
                    <p className="text-xs text-gray-500">Scheduled for tonight at 11 PM</p>
            ...
            {isProfileOpen && (
              <div className="absolute right-0 mt-2 w-48 bg-white rounded-lg shadow-lg border border-gray-200 z-50">
                ...
                <div className="border-t border-gray-200">
                  <a href="#" className="block px-4 py-2 text-sm text-red-700 hover:bg-red-50">
                    <div className="flex items-center space-x-2">
                      <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
